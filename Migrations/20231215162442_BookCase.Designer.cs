...
namespace Library.Migrations
{
    ...
    [Migration("20231215162442_BookCase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Models.Books.BookCase", b =>
                {
                    ...
                    b.HasIndex("BooksShelfId");

                    b.ToTable("Bookshelf1");
                });

            modelBuilder.Entity("Library.Models.Books.BooksShelf", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Library.Models.Books.BookCase", b =>
                {
                    b.HasOne("Library.Models.Books.BooksShelf", "BooksShelf")
                        .WithMany()
                        .HasForeignKey("BooksShelfId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BooksShelf");
                });
